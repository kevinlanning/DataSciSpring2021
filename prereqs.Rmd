...
This and all code will be stored in the class github repository (https://github.com/kevinlanning/introDataScience). 

Note that to run this, you may need to first *install* the Venndiagram package, that is, copy it on to your machine:
