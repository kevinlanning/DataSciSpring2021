...
The class will cover a series of modules, each of which may be covered in more than or less than a single class period.  My notes for these modules will be updated regularly [here](https://kevinlanning.github.io/DataSciSpring2018/).
...
## Towards data proficiency (wks 5-10)
...
## Towards data fluency (wks 10-14)
...
## Towards data leadership (wks 14-15)
